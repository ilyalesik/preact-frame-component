...
var Frame = function (_Component) {
  ...
  _createClass(Frame, [{
    ...
    value: function componentWillUnmount() {
      ...
      var doc = this.getDoc();
      if (doc) {
        _preactCompat2.default.unmountComponentAtNode(this.getMountTarget());
      }
    }
  }, {
    key: 'getDoc',
    value: function getDoc() {
      return _preactCompat2.default.findDOMNode(this).contentDocument; // eslint-disable-line
    }
  }, {
    key: 'getMountTarget',
    ...
    value: function renderFrameContents() {
      ...
      if (doc && doc.readyState === 'complete') {
        ...
        _preactCompat2.default.unstable_renderSubtreeIntoContainer(this, contents, mountTarget, callback);
        resetWarnings();
      } else {
